 ...
 * @since 3.1
 */
public class CommonsTreeList<E> extends AbstractList<E> {
...
//  LinkedList =  270;7360;3350;55860;290720;2910;55200;
     ...
     */
    public CommonsTreeList(final Collection<? extends E> coll) {
        super();
        if (!coll.isEmpty()) {
...
//        }
    ...
    static class TreeListIterator<E> implements ListIterator<E>, OrderedIterator<E> {
        /** The parent list */
        private final CommonsTreeList<E> parent;
        /**
         ...
         */
        protected TreeListIterator(final CommonsTreeList<E> parent, final int fromIndex) throws IndexOutOfBoundsException {
            super();
            this.parent = parent;
